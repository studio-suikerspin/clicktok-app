    ...
    <div class="container">
      <div class="logo__flex_inner">
        ...
        <div class="logo__wrapper">
          <img v-for="logo in logos" :src="logo.image" :alt="logo.title" />
        </div>
      </div>
    </div>
  </div>
...
.logo__flex_title{
  ...
  font-weight: 600;
  line-height: normal;
  font-size: clamp(2.25rem, .7222rem + 4.8889vw, 5rem);
  opacity: 1;
}

.logo__flex_title span{
